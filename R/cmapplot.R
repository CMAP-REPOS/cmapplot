...
cmapplot_globals$consts <- list(
  ...
  padding_legend = c(0,1,0,-5),
                        # [t,f] Padding for the legend element. The -5 adjustment is
                        #        necessary to left align legend key with plot
                        #        elements. Additional adjustments may be
                        #        required based on system configuration, which
                        #        can be done easily using `legend_bump`
