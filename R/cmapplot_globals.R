...
#' helper functions described here provide the user access if they need.
#'
...
#'   get/set. The function will parse \code{$}, or recursive list elements can
#'   be split over multiple arguments (e.g. \code{"font$strong$family"} is
