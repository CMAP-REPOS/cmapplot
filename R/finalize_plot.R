...
#' @param subtitle The text you want to appear in the subtitle block.  You can write the subtitle as one string, or add in newline breaks ('\n') with option autowrap = FALSE.
...
#' @param height The height in pixels for the image.  Default = 400.
#' @param type The type of output ('ppt', 'word', or 'web'). Use to set file extension and give max height warnings.  Only used when action = save.
#' @param sidepercent The rough percent of total width that the left column should take up.  Default = 23.
