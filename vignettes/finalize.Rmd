...
finalize_plot(plot = p,
              ...
              caption = "Source: Chicago Metropolitan Agency for Planning analysis of Regional Transportation Authority data")
```
...
finalize_plot(plot = p,
              ...
              caption = 'Source: <b><span style="color: purple;"><i>Chicago Metropolitan Agency for Planning</i></span> analysis of <i>RTA<sup>1</sup></i> data.</b><br><br><i><sup>1</sup> Regional Transportation Authority</i>')
```
