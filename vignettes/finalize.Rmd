...
One special case of the top-level position adjustments is the elimination of the title and caption altogether. By setting the `title_width = 0`, you can export a graph with just the plot and legend elements.
