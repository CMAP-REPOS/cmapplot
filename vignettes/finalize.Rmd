...
finalize_plot(plot = p,
              title = "Annual<br><i>unlinked</i> passenger trips <br> (in millions)",
              caption = "Source: Chicago Metropolitan Agency for <b>Planning
                analysis of <i>Regional</i></b> Transportation Authority data")
```
