...
One special case of the top-level position adjustments is the elimination of the title and caption altogether. By setting `title_width = 0`, you can export a graph without the left title-caption column. If a caption is specified, it is moved below the plot element. 
