...
p <- ggplot(data = df, mapping = aes(
  x = year, y = indexed,
  color = fct_reorder2(area, year, indexed),           # order legend by last `relative` in last `year`
...
<img src="https://www.dropbox.com/s/xol70o61citlpjj/Cumulative_Growth-01.png" width="100%" style="display: block; margin: auto;"/>

[Source](https://www.dropbox.com/s/xol70o61citlpjj/Cumulative_Growth-01.png)
