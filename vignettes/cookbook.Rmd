...
[Source](https://www.cmap.illinois.gov/programs/regional-economic-indicators/trends#Real_Gross_Regional_Product) (similar enough, although it hasn't been updated here in some time.)
...
p <- ggplot(data = df,
            mapping = aes(
              ...
              label = LABEL # note that this label definition is implicitly referenced by `geom_text()` (below)
            )) +
