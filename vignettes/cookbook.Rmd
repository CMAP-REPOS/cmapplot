...
p <- ggplot(data = df, mapping = aes(x = hours, y = value)) +
  ...
  theme_cmap(
    ...
    strip.text = element_text( # strip.text is an optional ... argument that can be added to theme_cmap()
...
finalize_plot(
  ...
  caption = "Note: A tour is a chain of trips that begin at and return to the
    ...
    <br><br>
    Modeled source: CMAP activity-based model, 2010 scenario.<br><br>Observed source: Travel Tracker Survey, 2007-2008."
)
```
