...
### Divergent palettes
Use these palettes with `cmap_fill_continuous()` `cmap_fill_discrete()`, or their `color` variants. Using these palettes for a discrete scale will behave similarly to the discrete use of `blues` shown above.
