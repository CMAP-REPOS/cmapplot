...
```{r echo=FALSE, out.height="40%", out.width="50%"}
viz_gradient(cmap_gradients$seq_reds)
viz_gradient(cmap_gradients$seq_oranges)
viz_gradient(cmap_gradients$seq_yellows)
viz_gradient(cmap_gradients$seq_greens)
viz_gradient(cmap_gradients$seq_teals)
viz_gradient(cmap_gradients$seq_blues)
viz_gradient(cmap_gradients$seq_purples)
viz_gradient(cmap_gradients$seq_grays)
```

#### Multi-hue sequential gradients

```{r echo=FALSE, out.height="40%", out.width="50%"}
viz_gradient(cmap_gradients$seq_yellow_orange_red)
viz_gradient(cmap_gradients$seq_green_teal_blue)
viz_gradient(cmap_gradients$seq_yellow_orange)
viz_gradient(cmap_gradients$seq_orange_red)
viz_gradient(cmap_gradients$seq_red_purple)
viz_gradient(cmap_gradients$seq_yellow_green)
viz_gradient(cmap_gradients$seq_green_teal)
viz_gradient(cmap_gradients$seq_teal_blue)
```

#### Multi-hue diverging gradients

```{r echo=FALSE, out.height="40%", out.width="50%"}
viz_gradient(cmap_gradients$div_yellow_purple)
viz_gradient(cmap_gradients$div_orange_blue)
viz_gradient(cmap_gradients$div_red_teal)
viz_gradient(cmap_gradients$div_purple_green)
viz_gradient(cmap_gradients$div_blue_yellow)
viz_gradient(cmap_gradients$div_teal_orange)
viz_gradient(cmap_gradients$div_green_red)
```
